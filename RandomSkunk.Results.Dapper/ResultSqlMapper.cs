...
public static class ResultSqlMapper
{
    ...
    /// <see langword="null"/>, then <see cref="Exception"/> is not caught.
    /// </param>
    ...
    /// </param>
    /// <returns>
    /// A sequence of data of <typeparamref name="T"/>; if a basic type (int, string, etc) is queried then the data from the
