...
public partial struct Result<T>
{
    ...
    public bool HasValue(T otherValue, IEqualityComparer<T>? comparer = null)
    {
        ...
        return _outcome == _successOutcome && comparer.Equals(_value!, otherValue);
    }
    ...
    public bool HasValue(Func<T, bool> comparison)
    {
        ...
        return _outcome == _successOutcome && comparison(_value!);
    }
}
...
{
    /// <inheritdoc cref="Result{T}.HasValue(T, IEqualityComparer{T}?)"/>
    public bool HasValue(T otherValue, IEqualityComparer<T>? comparer = null)
    {
        comparer ??= EqualityComparer<T>.Default;
    ...
    /// <inheritdoc cref="Result{T}.HasValue(Func{T, bool})"/>
    public bool HasValue(Func<T, bool> comparison)
    {
        if (comparison is null) throw new ArgumentNullException(nameof(comparison));
