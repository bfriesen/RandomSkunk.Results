...
/// <summary>
/// Defines methods that evaluate a delegate using a try-catch statement with a three catch blocks: the first has an exception of
/// type <typeparamref name="TException1"/>, the second has an exception of type <typeparamref name="TException2"/>, and the
/// third has an exceptions of type <typeparamref name="TException3"/>.
/// </summary>
...
public static class TryCatch<TException1, TException2, TException3>
    ...
    where TException3 : Exception
{
    ...
    /// delegate throws an exception of type <typeparamref name="TException1"/>, <typeparamref name="TException2"/>, or
    /// <typeparamref name="TException3"/>, it is caught and used to create the error for the returned <c>Fail</c> result.
    ...
    /// <typeparamref name="TException2"/>, or <typeparamref name="TException3"/>, it is caught and used to create the error for
