...
/// <content>
/// Defines the <c>AndAlso</c> and <c>AndAlsoAsync</c> methods.
/// </content>
public partial struct Result
{
    ...
    /// A function returning another <see cref="Result"/> that is only evaluated if this is a <c>Success</c> result.
    /// </param>
    /// <param name="onFail">
    /// An optional function for creating a custom error that is only evaluated if this is a <c>Fail</c> result.
    /// </param>
