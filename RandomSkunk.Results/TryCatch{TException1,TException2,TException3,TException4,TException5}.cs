...
/// <summary>
/// Defines methods that evaluate a delegate using a try-catch statement with a five catch blocks: the first has an exception of
/// type <typeparamref name="TException1"/>, the second has an exception of type <typeparamref name="TException2"/>, the third
/// has an exception of type <typeparamref name="TException3"/>, the fourth has an exception of type
/// <typeparamref name="TException4"/>, and the fifth has an exception of type <typeparamref name="TException5"/>.
/// </summary>
...
/// <typeparam name="TException5">The fifth type of exception to catch.</typeparam>
public static class TryCatch<TException1, TException2, TException3, TException4, TException5>
    ...
    where TException5 : Exception
{
    ...
    private static readonly Func<TException4, Error> _defaultException4Handler = TryCatch.GetErrorFromException;
    private static readonly Func<TException5, Error> _defaultException5Handler = TryCatch.GetErrorFromException;
    ...
    /// <typeparamref name="TException3"/>, <typeparamref name="TException4"/>, or <typeparamref name="TException5"/>, it is
    ...
    ///     <c>Fail</c> result's error. If <see langword="null"/>, the error is created by calling
    ///     <see cref="Error.FromException"/>.</param>
    /// <param name="exception5Handler">An optional function that maps a caught <typeparamref name="TException5"/> to a
    ///     <c>Fail</c> result's error. If <see langword="null"/>, the error is created by calling
    ///     <see cref="Error.FromException"/>.</param>
    ...
    public static Result AsResult(
        ...
        Func<TException5, Error>? exception5Handler = null)
    {
        ...
        if (exception5Handler is null) exception5Handler = _defaultException5Handler;
    ...
    /// <typeparamref name="TException2"/>, <typeparamref name="TException3"/>, <typeparamref name="TException4"/>, or
    /// <typeparamref name="TException5"/>, it is caught and used to create the error for the returned <c>Fail</c> result.
