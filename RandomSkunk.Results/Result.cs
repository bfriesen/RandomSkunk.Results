...
namespace RandomSkunk.Results
{
    ...
    public abstract class Result : ResultBase
    {
        ...
        public TResult Match<TResult>(Func<TResult> onSuccess, Func<string, int?, TResult> onFail)
        {
        ...
        /// code of the <c>fail</c> result are passed to this function.
        /// </param>
        public void Match(Action onSuccess, Action<string, int?> onFail)
        {
            ArgumentNullException.ThrowIfNull(onSuccess, nameof(onSuccess));
            ArgumentNullException.ThrowIfNull(onFail, nameof(onFail));
        ...
        /// </param>
        /// <returns>The result of the matching function evaluation.</returns>
        public Task<TResult> MatchAsync<TResult>(Func<Task<TResult>> onSuccess, Func<string, int?, Task<TResult>> onFail)
        {
            ArgumentNullException.ThrowIfNull(onSuccess, nameof(onSuccess));
            ArgumentNullException.ThrowIfNull(onFail, nameof(onFail));
        ...
        /// code of the <c>fail</c> result are passed to this function.
        /// </param>
        public Task MatchAsync(Func<Task> onSuccess, Func<string, int?, Task> onFail)
        {
            ArgumentNullException.ThrowIfNull(onSuccess, nameof(onSuccess));
            ArgumentNullException.ThrowIfNull(onFail, nameof(onFail));
        ...
        {
            public SuccessResult(CallSite callSite) : base(callSite) { }
